 ...
 */
export declare type FTSearchResponse = number | FTSearchArrayResponse | FTParsedSearchResponse;
/**
 * The response type of the FT search function as an array
 */
export declare type FTSearchArrayResponse = [number, ...Array<string | string[] | {
    [key: string]: string;
}>];
/**
 * The response type of the FT aggregate function
 */
export declare type FTAggregateResponse = {
 ...
 */
export declare type FTAggregateResponseItem = {
    name: string;
 ...
 */
export declare type FTParsedSearchResponse = {
    resultsCount: number;
    documentIds: string[];
    data: string[];
};
