...
exports.SearchCommander = void 0;
var SearchCommander = /** @class */ (function () {
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.create = function (index, indexType, schemaFields, parameters) {
        var args = [index, 'ON', indexType];
        if (parameters !== undefined) {
            if (parameters.prefix !== undefined) {
                args.push('PREFIX');
                if (parameters.prefix.num !== undefined) {
                    args.push("".concat(parameters.prefix.num));
                }
                else if (Array.isArray(parameters.prefix.prefixes)) {
                    args.push("".concat(parameters.prefix.prefixes.length));
                }
                else {
                    args.push("1");
                }
            ...
            if (parameters.maxTextFields !== undefined)
                args = args.concat(['MAXTEXTFIELDS', "".concat(parameters.maxTextFields)]);
            if (parameters.temporary !== undefined)
                args = args.concat(['TEMPORARY', "".concat(parameters.temporary)]);
            ...
            if (parameters.stopwords !== undefined) {
                ...
                if (parameters.stopwords.num !== undefined) {
                    args.push("".concat(parameters.stopwords.num));
                }
                else if (Array.isArray(parameters.stopwords.stopwords)) {
                    args.push("".concat(parameters.stopwords.stopwords.length));
                }
                else {
                    args.push("1");
                }
        ...
        args.push('SCHEMA');
        for (var _i = 0, schemaFields_1 = schemaFields; _i < schemaFields_1.length; _i++) {
            var field = schemaFields_1[_i];
            args.push(field.name);
            if (field.as !== undefined)
                args = args.concat(['AS', field.as]);
            args.push(field.type);
            if (field.nostem === true)
                args.push('NOSTEM');
            if (field.weight !== undefined)
                args = args.concat(['WEIGHT', "".concat(field.weight)]);
            if (field.phonetic !== undefined)
                args = args.concat(['PHONETIC', field.phonetic]);
            if (field.separator !== undefined)
                args = args.concat(['SEPARATOR', field.separator]);
            if (field.sortable === true)
                args.push('SORTABLE');
            if (field.noindex === true)
                args.push('NOINDEX');
            if (field.unf === true)
                args.push('UNF');
            if (field.caseSensitive === true)
     ...
     */
    SearchCommander.prototype.search = function (index, query, parameters) {
        var _a;
        var args = [index, query];
        if (parameters !== undefined) {
            ...
            if (parameters.filter !== undefined) {
                for (var _i = 0, _b = parameters.filter; _i < _b.length; _i++) {
                    var filterItem = _b[_i];
                    args = args.concat(['FILTER', filterItem.field, "".concat(filterItem.min), "".concat(filterItem.max)]);
                }
            }
            if (parameters.geoFilter !== undefined)
                args = args.concat([
                    ...
                    "".concat(parameters.geoFilter.lon),
                    "".concat(parameters.geoFilter.lat),
                    "".concat(parameters.geoFilter.radius),
                    parameters.geoFilter.measurement
                ]);
            if (parameters.inKeys !== undefined) {
                args.push('INKEYS');
                if (parameters.inKeys.num !== undefined) {
                    args.push("".concat(parameters.inKeys.num));
                }
                else if (Array.isArray(parameters.inKeys.keys)) {
                    args.push("".concat(parameters.inKeys.keys.length));
                }
                else {
                    args.push("1");
                }
            ...
            if (parameters.inFields !== undefined) {
                ...
                if (parameters.inFields.num !== undefined) {
                    args.push("".concat(parameters.inFields.num));
                }
                else if (Array.isArray(parameters.inFields.fields)) {
                    args.push("".concat(parameters.inFields.fields.length));
                }
                else {
                    args.push("1");
                }
            ...
            if (parameters.return !== undefined) {
                args = (_a = args.concat([
                    ...
                    parameters.return.num !== undefined ?
                        "".concat(parameters.return.num) :
                        "".concat(parameters.return.fields.length),
                ])).concat.apply(_a, parameters.return.fields.map(function (field) {
                    if (field.as !== undefined) {
            ...
            if (parameters.summarize !== undefined) {
                ...
                if (parameters.summarize.fields !== undefined) {
                    ...
                    if (parameters.summarize.fields.num !== undefined) {
                        args.push("".concat(parameters.summarize.fields.num));
                    }
                    else if (Array.isArray(parameters.summarize.fields.fields)) {
                        args.push("".concat(parameters.summarize.fields.fields.length));
                    }
                    else {
                        args.push("1");
                    }
                ...
                if (parameters.summarize.frags !== undefined)
                    args = args.concat(['FRAGS', "".concat(parameters.summarize.frags)]);
                if (parameters.summarize.len !== undefined)
                    args = args.concat(['LEN', "".concat(parameters.summarize.len)]);
            ...
            if (parameters.highlight !== undefined) {
                ...
                if (parameters.highlight.fields !== undefined) {
                    ...
                    if (parameters.highlight.fields.num !== undefined) {
                        args.push("".concat(parameters.highlight.fields.num));
                    }
                    else if (Array.isArray(parameters.highlight.fields.fields)) {
                        args.push("".concat(parameters.highlight.fields.fields.length));
                    }
                    else {
                        args.push("1");
                    }
            ...
            if (parameters.slop !== undefined)
                args = args.concat(['SLOP', "".concat(parameters.slop)]);
            ...
            if (parameters.limit !== undefined)
                args = args.concat(['LIMIT', "".concat(parameters.limit.first), "".concat(parameters.limit.num)]);
        }
        return {
            command: 'FT.SEARCH',
            args: args
     ...
     */
    SearchCommander.prototype.aggregate = function (index, query, parameters) {
        var args = [index, query];
        if (parameters !== undefined) {
            if (parameters.load !== undefined) {
                ...
                if (parameters.load.properties !== undefined)
                    parameters.load.properties.forEach(function (property) {
                        args.push(property);
                    });
            }
            if (parameters.apply !== undefined) {
                parameters.apply.forEach(function (apply) {
                    args.push('APPLY');
            ...
            if (parameters.groupby !== undefined) {
                ...
                if (parameters.groupby.properties !== undefined) {
                    parameters.groupby.properties.forEach(function (property) {
                        args.push(property);
                    });
                }
            }
            if (parameters.reduce !== undefined) {
                parameters.reduce.forEach(function (reduce) {
                    args.push('REDUCE');
                    ...
                    if (reduce.args)
                        reduce.args.forEach(function (arg) {
                            args.push(arg);
                        });
            ...
            if (parameters.sortby !== undefined) {
                ...
                if (parameters.sortby.properties)
                    parameters.sortby.properties.forEach(function (property) {
                        args.push(property.property);
                        args.push(property.sort);
                    });
                if (parameters.sortby.max !== undefined)
                    args = args.concat(['MAX', "".concat(parameters.sortby.max)]);
            }
            if (parameters.expressions !== undefined) {
                parameters.expressions.forEach(function (expression) {
                    args.push('APPLY');
            ...
            if (parameters.limit !== undefined) {
                ...
                if (parameters.limit.numberOfResults !== undefined)
                    args.push("".concat(parameters.limit.numberOfResults));
            }
        }
        return {
     ...
     */
    SearchCommander.prototype.explain = function (index, query) {
        return {
            command: 'FT.EXPLAIN',
            args: [index, query]
        };
     ...
     */
    SearchCommander.prototype.explainCLI = function (index, query) {
        return {
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.alter = function (index, field, fieldType, options) {
        var args = [index, 'SCHEMA', 'ADD', field, fieldType];
        if (options !== undefined) {
            if (options.nostem === true)
                args.push('NOSTEM');
            if (options.weight !== undefined)
                args = args.concat(['WEIGHT', "".concat(options.weight)]);
            if (options.phonetic !== undefined)
                args = args.concat(['PHONETIC', options.phonetic]);
            if (options.separator !== undefined)
                args = args.concat(['SEPARATOR', options.separator]);
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.dropindex = function (index, deleteHash) {
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.aliasadd = function (name, index) {
        return {
            command: 'FT.ALIASADD',
            args: [name, index]
        };
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.aliasupdate = function (name, index) {
        return {
     ...
     * @returns 'OK' or error
     */
    SearchCommander.prototype.aliasdel = function (name) {
        return {
            command: 'FT.ALIASDEL',
            args: [name]
        };
     ...
     */
    SearchCommander.prototype.tagvals = function (index, field) {
        return {
            command: 'FT.TAGVALS',
            args: [index, field]
        };
     ...
     */
    SearchCommander.prototype.sugadd = function (key, suggestion, score, options) {
        var args = [key, suggestion, score];
        if (options !== undefined) {
     ...
     */
    SearchCommander.prototype.sugget = function (key, prefix, options) {
        var args = [key, prefix];
        if (options !== undefined) {
            if (options.fuzzy === true)
                args.push('FUZZY');
            if (options.max !== undefined)
                args = args.concat(['MAX', "".concat(options.max)]);
     ...
     * @param suggestion The suggestion
     */
    SearchCommander.prototype.sugdel = function (key, suggestion) {
        return {
            command: 'FT.SUGDEL',
            args: [key, suggestion]
        };
     ...
     * @param key The key
     */
    SearchCommander.prototype.suglen = function (key) {
        return {
            command: 'FT.SUGLEN',
            args: [key]
        };
     ...
     * @returns 'OK'
     */
    SearchCommander.prototype.synupdate = function (index, groupId, terms, skipInitialScan) {
        if (skipInitialScan === void 0) { skipInitialScan = false; }
        var args = [index, groupId];
     ...
     */
    SearchCommander.prototype.syndump = function (index) {
        return {
            command: 'FT.SYNDUMP',
            args: [index]
        };
     ...
     */
    SearchCommander.prototype.spellcheck = function (index, query, options) {
        var args = [index, query];
        if (options !== undefined) {
            if (options.distance !== undefined)
                args = args.concat(['DISTANCE', "".concat(options.distance)]);
            if (options.terms !== undefined) {
                args.push('TERMS');
                for (var _i = 0, _a = options.terms; _i < _a.length; _i++) {
                    var term = _a[_i];
     ...
     */
    SearchCommander.prototype.dictadd = function (dict, terms) {
        return {
            command: 'FT.DICTADD',
     ...
     */
    SearchCommander.prototype.dictdel = function (dict, terms) {
        return {
            command: 'FT.DICTDEL',
            args: [dict].concat(terms)
        };
     ...
     */
    SearchCommander.prototype.dictdump = function (dict) {
        return {
            command: 'FT.DICTDUMP',
            args: [dict]
        };
     ...
     */
    SearchCommander.prototype.info = function (index) {
        return {
            command: 'FT.INFO',
            args: [index]
        };
     ...
     */
    SearchCommander.prototype.config = function (command, option, value) {
    ...
    return SearchCommander;
}());
exports.SearchCommander = SearchCommander;
