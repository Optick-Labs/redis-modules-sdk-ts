...
describe('RediSearch Module testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('create function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the FT.CREATE command');
        ...
        it('search function on JSON', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(0, 'The response of the FT.SEARCH command');
        ...
        it('Simple search test with field specified in query', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(count).to.equal(2, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(result[0].key).to.equal('doc:1', 'first document key');
        }));
        it('Simple search tests with field specified using inFields', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res).to.equal(0, 'Total number of returining document of FT.SEARCH command');
            res = yield redis.search_module_search(`${index}-searchtest`, 'Doe', {
                inFields: {
                    fields: ['name']
                }
            });
            chai_1.expect(res[0]).to.equal(2, 'Total number of returining document of FT.SEARCH command');
        }));
        ...
        it('Search tests with filter', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(1, 'Total number of returining document of FT.SEARCH command');
        }));
        it('Search tests with return', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(3, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(Object.keys(res[1]).length).to.equal(2, 'Total number of returned key-values');
            chai_1.expect(Object.keys(res[1]).includes('age')).to.equal(true, 'Age must be returned');
            chai_1.expect(Object.keys(res[1]).includes('salary')).to.equal(false, 'Salary must not be returned');
            chai_1.expect(Object.keys(res[1]).includes('name')).to.equal(false, 'Name must not be returned');
            chai_1.expect(Object.keys(res[2]).length).to.equal(2, 'Total number of returned key-values');
            chai_1.expect(Object.keys(res[3]).length).to.equal(2, 'Total number of returned key-values');
            ...
            chai_1.expect(res[0]).to.equal(1, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(Object.keys(res[1]).includes('age')).to.equal(true, 'Age must be returned');
            chai_1.expect(Object.keys(res[1]).includes('salary')).to.equal(true, 'Salary must be returned');
            chai_1.expect(Object.keys(res[1]).includes('name')).to.equal(false, 'Name must not be returned');
            res = (yield redis.search_module_search(`${index}-searchtest`, '*', {
                return: { fields: [] }
            }));
            chai_1.expect(res.length).to.equal(4, 'Only keys should be returned (+count of them)');
        }));
        it('Search test with summarize', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(2, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(res[1].introduction.endsWith('!?!')).to.equal(true, 'Custom summarize separator');
            chai_1.expect(res[1].introduction.endsWith('!?!')).to.equal(true, 'Custom summarize separator');
        }));
        it('Search tests with highlight', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(2, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(res[1].name.includes('**')).to.equal(false, 'Name mustn\'t be highlighted');
            chai_1.expect(res[1].introduction.includes('**developer**')).to.equal(true, 'Introduction must be highlighted');
        }));
        it('Search test with sortby ', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(3, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(res[1].age).to.equal('25', 'Ages should be returned in ascending order');
            chai_1.expect(res[2].age).to.equal('30', 'Ages should be returned in ascending order');
            chai_1.expect(res[3].age).to.equal('80', 'Ages should be returned in ascending order');
        }));
        it('Search test with limit', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(res[0]).to.equal(3, 'Total number of returining document of FT.SEARCH command');
            chai_1.expect(res.length).to.equal(2, 'Only one item should be returned');
        }));
        it('aggregate function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.numberOfItems).to.equal(0, 'The response of the FT.AGGREGATE command');
        }));
        it('aggregate function response', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.numberOfItems).to.equal(2, 'Total number of the FT.AGGREGATE command result');
            chai_1.expect(response.items[0].name).to.equal('city', 'Aggreagated prop of the FT.AGGREGATE command result');
            ...
            chai_1.expect(response.numberOfItems).to.equal(2, 'Total number of the FT.AGGREGATE command result');
            chai_1.expect(response.items[0].name).to.equal('hour', 'Aggreagated apply prop of the FT.AGGREGATE command result');
        ...
        it('explain function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.contain('@NULL:UNION', 'The response of the FT.EXPLAIN command');
        }));
        it('explainCLI function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('@NULL:UNION {  @NULL:name  @NULL:+name(expanded)}', 'The response of the FT.EXPLAINCLI command');
        }));
        it('alter function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_alter(index, 'tags', 'TAG');
            chai_1.expect(response).to.equal('OK', 'The response of the FT.ALTER command');
        }));
        it('aliasadd function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_aliasadd(alias, index);
            chai_1.expect(response).to.equal('OK', 'The response of the FT.ALIASADD command');
        }));
        it('aliasupdate function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the FT.ALIASUPDATE command');
        }));
        it('aliasdel function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_aliasdel(alias);
            chai_1.expect(response).to.equal('OK', 'The response of the FT.ALIASDEL command');
        }));
        it('sugadd function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(1, 'The response of the FT.SUGADD command');
        }));
        it('sugget function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('str', 'The response of the FT.SUGGET command');
        }));
        it('suglen function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_suglen(sug.key);
            chai_1.expect(response).to.equal(1, 'The response of the FT.SUGLEN command');
        }));
        it('sugdel function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(1, 'The response of the FT.SUGDEL command');
        }));
        it('tagvalgs function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_tagvals(index, 'tags');
            chai_1.expect(response.length).to.equal(0, 'The response of the FT.TAGVALS command');
        }));
        it('synupdate function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the FT.SYNUPDATE command');
        }));
        it('syndump function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_syndump(index);
            chai_1.expect(response.term1).to.equal('0', 'The response of the FT.SYNDUMP command');
        }));
        it('spellcheck function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0].suggestions.length).to.equal(0, 'No suggestion should be found');
            response = yield redis.search_module_spellcheck(`${index}-spellcheck`, "mellow blua");
            chai_1.expect(response.length).to.equal(2, 'Both word should be spellchecked');
        }));
        it('dictadd function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(1, 'The response of the FT.DICTADD command');
        }));
        it('dictdel function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(1, 'The response of the FT.DICDEL command');
        }));
        it('dictdump function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('termY1', 'The response of the FT.DICTDUMP command');
        ...
        it('info function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.index_name).to.equal(index, 'The index name');
        }));
        it('config function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.search_module_config('GET', '*');
            chai_1.expect(response.EXTLOAD).to.equal(null, 'The EXTLOAD value');
        }));
        it('dropindex function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the FT.DROPINDEX command');
        }));
        it('Testing the parse of search function as JSON', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(resultsCount).to.equal(1, 'The count of the results');
        }));
    });
});
