...
describe('RedisGraph Module testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('query function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[2].find(item => item === 'Labels added: 1')).to.not.equal(undefined, 'The value of Labels added');
            chai_1.expect(response[2].find(item => item === 'Nodes created: 1')).to.not.equal(undefined, 'The value of Nodes created');
            chai_1.expect(response[2].find(item => item === 'Properties set: 2')).to.not.equal(undefined, 'The value of Properties set');
            chai_1.expect(response[2].find(item => item === 'Cached execution: 0')).to.not.equal(undefined, 'The value of Cached execution');
            response = yield redis.graph_module_query(graphName, `MATCH (p:Person) WHERE p.name=$name RETURN count(p) as count`, { name: 'Kurt' });
            chai_1.expect(response[2].find(item => item === 'Cached execution: 0')).to.not.equal(undefined, 'The response of the GRAPH.QUERY command');
        }));
        it('readonlyQuery function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[2][0]).to.equal('Cached execution: 0', 'The response of the GRAPH.RO_QUERY command');
        ...
        it('profile function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.contain('Results | Records produced: 0', 'The response of the GRAPH.QUERY command');
        }));
        it('explain function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal('Results', 'The response of the GRAPH.EXPLAIN command');
            chai_1.expect(response[1]).to.contain('Project', 'The response of the GRAPH.EXPLAIN command');
            chai_1.expect(response[2]).to.contain('Filter', 'The response of the GRAPH.EXPLAIN command');
            chai_1.expect(response[3]).to.contain('Node By Label Scan | (p:Person)', 'The response of the GRAPH.EXPLAIN command');
        }));
        it.skip('slowlog function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.graph_module_slowlog(1);
            chai_1.expect(response.length).to.equal(0, 'The response of the GRAPH.SLOWLOG command');
        }));
        it('delete function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.graph_module_delete(graphName);
            chai_1.expect(response).to.contain('Graph removed', 'The response of the GRAPH.DELETE command');
        }));
        it('config function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.eql('OK', 'The RESULT SET SIZE');
            let response2 = yield redis.graph_module_config('GET', 'RESULTSET_SIZE');
            chai_1.expect(response2.RESULTSET_SIZE).to.eql(1000, 'The RESULT SET SIZE');
            response2 = (yield redis.graph_module_config('GET', '*'));
            chai_1.expect(response2.CACHE_SIZE).to.eql(25, 'The CACHE_SIZE of the module');
        }));
    });
});
