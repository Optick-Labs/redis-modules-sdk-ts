...
describe('RedisBloom TDigest filter testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('create function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of \'TDIGEST.CREATE\' command');
        ...
        it('reset function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of \'TDIGEST.RESET\' command');
        }));
        ...
        it('quantile function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.eql('1500', 'The response of \'TDIGEST.QUANTILE\' command');
        }));
        it('cdf function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_tdigest_module_cdf(key1, 10);
            chai_1.expect(response).to.eql('0', 'The response of \'TDIGEST.CDF\' command');
        }));
        it('info function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_tdigest_module_info(key1);
            chai_1.expect(response.Compression).to.eql(100, 'The compression');
            chai_1.expect(response.Capacity).to.eql(610, 'The capacity');
            chai_1.expect(response['Merged nodes']).to.eql(1, 'The merged nodes');
            chai_1.expect(response['Unmerged nodes']).to.eql(0, 'The unmerged nodes');
            chai_1.expect(response['Merged weight']).to.eql('1', 'The merged weight');
            chai_1.expect(response['Unmerged weight']).to.eql('0', 'The unmerged weight');
            chai_1.expect(response['Total compressions']).to.eql(1, 'The total compressions');
        }));
    });
});
