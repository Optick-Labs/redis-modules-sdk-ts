...
describe('RedisGears Module testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('pyexecute function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(executionId1).to.equal('0000000000000000000000000000000000000000-0', 'The execution id');
            ...
            chai_1.expect(executionId2).to.equal('0000000000000000000000000000000000000000-1', 'The execution id');
            executionId3 = yield redis.gears_module_pyexecute('GB().run()', {
                unblocking: true
            });
            console.log(`Execution ID: ${executionId3}`);
            chai_1.expect(executionId3).to.equal('0000000000000000000000000000000000000000-2', 'The execution id');
        }));
        it('configSet function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(0, 'The response count of the \'RG.CONFIGSET\' Command');
        }));
        it('configGet function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal(0, 'The response count of the \'RG.CONFIGGET\' Command');
        }));
        it('getExecution function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0][3][1]).to.equal('done', 'The response count of the \'RG.GETEXECUTION\' Command');
        }));
        it('dumpExecutions function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.gears_module_dumpExecutions();
            chai_1.expect(response[1][1]).to.equal(executionId1, 'The execution id');
            chai_1.expect(response[0][1]).to.equal(executionId2, 'The execution id');
        }));
        it('dumpRegistrations function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(0, 'The response count of the \'RG.DUMPREGISTRATIONS\' Command');
        }));
        it('getResults function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(2, 'The response count of the \'RG.GETRESULTS\' Command');
        }));
        ...
        it('trigger function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal('[\'mytrigger\', \'foo\', \'bar\']', 'The response of the \'RG.TRIGGER\' Command');
        }));
        it('dropExecution function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the \'RG.DROPEXECUTION\' Command');
        }));
        it('abortExecution function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the \'RG.ABORTEXECUTION\' Command');
        }));
        it('unregister function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the \'RG.UNREGISTER\' command');
        }));
    });
});
