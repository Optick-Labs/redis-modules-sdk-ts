...
describe('RedisIntervalSets Module testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('add function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.eql('OK', 'The response of the \'iset.add\' command');
        }));
        it('get function', () => __awaiter(this, void 0, void 0, function* () {
            let sets = yield redis.ris_module_get('ages');
            chai_1.expect(sets.length).to.eql(2, 'The number of sets');
            sets = yield redis.ris_module_get('ages', 'kids');
            chai_1.expect(sets.length).to.eql(1, 'The number of sets');
            chai_1.expect(sets[0].minimum).to.eql(0, 'The minimum score of set');
            chai_1.expect(sets[0].maximum).to.eql(100, 'The maximum score of set');
        }));
        it('score function', () => __awaiter(this, void 0, void 0, function* () {
            let sets = yield redis.ris_module_score('ages', 5);
            chai_1.expect(sets.length).to.eql(1, 'The number of sets');
            chai_1.expect(sets[0]).to.eql('kids', 'The name of the set');
        ...
        it('notScore function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(sets.length).to.eql(1, 'The number of sets');
            chai_1.expect(sets[0]).to.eql('parents', 'The name of the set');
        ...
        it('del function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.eql('OK', 'The response of the \'iset.del\' command');
            const sets = yield redis.ris_module_get('ages');
            chai_1.expect(sets.length).to.eql(1, 'The sets count');
