...
describe('RTS Module testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('create function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the create command');
        ...
        it('alter function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the alter command');
        }));
        it('add function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal(date, 'The response of the add command');
        }));
        it('madd function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(1, 'The response of the madd command');
        }));
        it('incrby function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(newValue).to.be.above(currentValue, 'The response of the incrby command');
        }));
        it('decrby function', () => __awaiter(this, void 0, void 0, function* () {
            const currentValue = parseInt((yield redis.rts_module_get(key1))[1].toString());
            yield redis.rts_module_decrby(key1, '1');
            const newValue = parseInt((yield redis.rts_module_get(key1))[1].toString());
            chai_1.expect(currentValue).to.be.above(newValue, 'The response of the decrby command');
        }));
        it('createrule function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response).to.equal('OK', 'The response of the createrule command');
        }));
        it('deleterule function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.rts_module_deleterule(key1, key2);
            chai_1.expect(response).to.equal('OK', 'The response of the deleterule command');
        }));
        it('range function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(0, 'The range items length of the response');
        ...
        it('mrange function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0][0]).to.equal(key, 'The filtered key name');
            ...
            chai_1.expect(response[0][0]).to.equal(filter, 'The value of the filter');
            chai_1.expect(response[0][1][0][0]).to.equal('label', 'The name of the label');
            chai_1.expect(response[0][1][0][1]).to.equal('value', 'The value of the label value');
            chai_1.expect(response[0][1][1][0]).to.equal('__reducer__', 'The key of the reducer');
            chai_1.expect(response[0][1][1][1]).to.equal('max', 'The value of the reducer');
            chai_1.expect(response[0][1][2][0]).to.equal('__source__', 'The key of the source');
            chai_1.expect(response[0][1][2][1]).to.equal(key, 'The value of the source');
        }));
        it('mrevrange function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0][0]).to.equal('key:2:32', 'The filtered key name');
        ...
        it('get function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.length).to.equal(2, 'The response of the get command');
        }));
        it('mget function', () => __awaiter(this, void 0, void 0, function* () {
            let response = yield redis.rts_module_mget('label=value');
            chai_1.expect(response.length).to.equal(1, 'The response of the mget command');
            response = yield redis.rts_module_mget('label=value label1=value1');
            console.log(response);
            chai_1.expect(response.length).to.equal(0, 'The response of the mget command');
        ...
        it('info function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response.totalSamples).to.be.greaterThan(0, 'The total samples of the key');
        }));
        it('queryindex function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.rts_module_queryindex('label=value');
            chai_1.expect(response.length).eql(1, 'The response of the queryindex command');
        }));
        it('del function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(samplesCount).eql(3, 'The response TS.DEL command');
        }));
    });
});
